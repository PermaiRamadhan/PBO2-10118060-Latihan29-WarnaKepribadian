 ...
 */
package pbo2.pkg10118060.latihan.ke.pkg29.warnakepribadian;
 ...
 * NIM  :10118060
 * Deskripsi Program    : program cek kepribadian dari warna favorit
 */
public class PBO210118060LatihanKe29WarnaKepribadian {
    ...
    public static void main(String[] args) {
        ...
        cek_kepribadian(clr.toLowerCase());
        System.out.println("");
        System.out.println(ANSI_RED_BACKGROUND+ANSI_WHITE+"Developed by"+ANSI_WHITE_BACKGROUND+ANSI_RED+" Permai Ramadhan"+ANSI_RESET);
    }
